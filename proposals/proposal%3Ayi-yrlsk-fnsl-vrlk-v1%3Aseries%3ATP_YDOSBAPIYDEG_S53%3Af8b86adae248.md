...
id: proposal:yi-yrlsk-fnsl-vrlk-v1:series:TP_YDOSBAPIYDEG_S53:f8b86adae248
proposal_id: proposal:yi-yrlsk-fnsl-vrlk-v1:series:TP_YDOSBAPIYDEG_S53:f8b86adae248
title: Semantic proposal for TP.YDOSBAPIYDEG.S53
status: approved
target_type: series
target_id: evds:TP.YDOSBAPIYDEG.S53
...
confidence: 0.9
source: heuristic
evidence_fingerprint: f8b86adae248c05cb5569d6dcf4d42f9c6902f11
catalog_record_id: catalog:evds2:TP.YDOSBAPIYDEG.S53
memory_rule_ids: []
evidence:
  ticker: TP.YDOSBAPIYDEG.S53
  notebook_slug: yi-yrlsk-fnsl-vrlk-v1
...
llm_provider: ''
llm_model: ''
promoted_record_id: evds:TP.YDOSBAPIYDEG.S53
promoted_memory_rule_id: memory:global-tp-ydosbapiydeg-s53
notes: 'Catalog source: catalog:evds2:TP.YDOSBAPIYDEG.S53 | Notebookta diger hanehalki
  alt kirilimlariyla birlikte USD/TL ile carpilarak ''Ozel Sektor Eurobond (Gercek
  Kisi)'' hesabinda kullaniliyor.'
body: "# Semantic proposal for TP.YDOSBAPIYDEG.S53\n\n## Target\nseries | evds:TP.YDOSBAPIYDEG.S53\n\
  ...
  -\n\n## Source\nheuristic\n\n## Approval Mode\n-\n\n## Approval Reason\n-\n\n##\
  \ Notes\nCatalog source: catalog:evds2:TP.YDOSBAPIYDEG.S53 | Notebookta diger hanehalki\
  \ alt kirilimlariyla birlikte USD/TL ile carpilarak 'Ozel Sektor Eurobond (Gercek\
  \ Kisi)' hesabinda kullaniliyor.\n\n## Evidence\n{\n  \"ticker\": \"TP.YDOSBAPIYDEG.S53\"\
  ,\n  \"notebook_slug\": \"yi-yrlsk-fnsl-vrlk-v1\",\n  \"official_series_name\":\
  \ \"Hanehalkı (S.14) (Diğer Finansal Aracılar Tarafından İhraç Edilen)\",\n  \"\
  context_title\": \"Hanehalkı (S.14) (Diğer Finansal Aracılar Tarafından İhraç Edilen)\"\
  ,\n  \"frequency\": \"weekly\",\n  \"unit\": \"Milyon ABD Dolari\",\n  \"role\"\
  : \"stock_component\",\n  \"status\": \"derived_input\",\n  \"theme_ids\": [\n \
  \   \"theme:resident-financial-assets\",\n    \"theme:resident-securities\",\n \
  ...
  : [\n    \"source:yiyrlsk-mkk-hisse-manual\",\n    \"source:yiyrlsk-mkk-fon-manual\"\
  ,\n    \"source:yiyrlsk-vap-scrape-attempt\"\n  ],\n  \"catalog_record\": {\n  \
  \  \"id\": \"catalog:evds2:TP.YDOSBAPIYDEG.S53\",\n    \"title\": \"1.C.1.4.Hanehalkı\
  \ (S.14) (Diğer Finansal Aracı İhraçları)\",\n    \"frequency\": \"weekly\",\n \
  \   \"unit\": \"milyon ABD doları\",\n    \"data_group\": \"bie_ydosbapiydeg\",\n\
  \    \"category\": \"GENEL YÖNETİM DIŞI SEKTÖRLERİN YURT DIŞI BORÇLANMA SENEDİ İHRAÇLARI\"\
  \n  },\n  \"memory_rules\": [],\n  \"source_snippets\": [\n    \"'TP.YDOSBAPIYDEG.S15',\
...
path: C:\Users\bthkr\OneDrive\Masaüstü\İş Kodlama\İş Agentı\proposals\proposal%3Ayi-yrlsk-fnsl-vrlk-v1%3Aseries%3ATP_YDOSBAPIYDEG_S53%3Af8b86adae248.md
approval_reason: LLM returned no concrete blocker after deterministic safety checks.
approval_mode: auto_llm
---
# Semantic proposal for TP.YDOSBAPIYDEG.S53
...
## Notes
Catalog source: catalog:evds2:TP.YDOSBAPIYDEG.S53 | Notebookta diger hanehalki alt kirilimlariyla birlikte USD/TL ile carpilarak 'Ozel Sektor Eurobond (Gercek Kisi)' hesabinda kullaniliyor.
