...
id: proposal:prbnk-mnklkymt-v5:series:TP_AB_A11:d40cfcd38728
proposal_id: proposal:prbnk-mnklkymt-v5:series:TP_AB_A11:d40cfcd38728
...
confidence: 0.8
source: hybrid
evidence_fingerprint: d40cfcd387287da87f55c8b5d1d0d8cc4006eaeb
...
evidence:
  ...
  - '"TP_AB_A11": [2, "I-Dış Yükümlülükler"],'
  indicator_hints: []
  notes: ''
llm_provider: ollama_cloud
llm_model: qwen3.5:397b-cloud
promoted_record_id: evds:TP.AB.A11
promoted_memory_rule_id: memory:global-tp-ab-a11
notes: 'Catalog source: catalog:evds2:TP.AB.A11'
body: "# Semantic proposal for TP.AB.A11\n\n## Target\nseries | evds:TP.AB.A11\n\n\
  ...
  - theme:foreign-ownership\n- theme:swap-and-securities\n\n## Candidate Indicator\
  \ Inputs\n-\n\n## Formula Hint\n-\n\n## Source\nhybrid\n\n## Notes\nCatalog source:\
  \ catalog:evds2:TP.AB.A11\n\n## Evidence\n{\n  \"ticker\": \"TP.AB.A11\",\n  \"\
  notebook_slug\": \"prbnk-mnklkymt-v5\",\n  \"official_series_name\": \"P.1a_Dış\
  \ Yükümlülükler(Bin TL)\",\n  \"context_title\": \"P.1a_Dış Yükümlülükler(Bin TL)\"\
  ,\n  \"frequency\": \"weekly\",\n  \"unit\": \"Bin TL\",\n  \"role\": \"balance_sheet_line\"\
  ,\n  \"status\": \"derived_input\",\n  \"theme_ids\": [\n    \"theme:portfolio-flows\"\
  ,\n    \"theme:foreign-ownership\",\n    \"theme:swap-and-securities\"\n  ],\n \
  \ \"indicator_ids\": [],\n  \"source_dependency_ids\": [\n    \"source:prbnk-weekly-zip\"\
...
path: C:\Users\bthkr\OneDrive\Masaüstü\İş Kodlama\İş Agentı\proposals\proposal%3Aprbnk-mnklkymt-v5%3Aseries%3ATP_AB_A11%3Ad40cfcd38728.md
---
