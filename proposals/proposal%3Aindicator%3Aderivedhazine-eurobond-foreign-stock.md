...
notebook_slug: ''
notebook_path: ''
candidate_title: Hazine Eurobond Foreign Stock
candidate_unit: ''
candidate_frequency: ''
candidate_role: ''
candidate_theme_ids:
...
body: '# Implied indicator proposal for derived:hazine-eurobond-foreign-stock
  ...
  indicator | derived:hazine-eurobond-foreign-stock
  ...
  '
path: C:\Users\bthkr\OneDrive\Masaüstü\İş Kodlama\İş Agentı\proposals\proposal%3Aindicator%3Aderivedhazine-eurobond-foreign-stock.md
---
# Implied indicator proposal for derived:hazine-eurobond-foreign-stock
