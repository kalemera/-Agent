...
id: proposal:yi-yrlsk-fnsl-vrlk-v1:series:TP_YIOSBAPIYDEG_S16:3b8cf586994a
proposal_id: proposal:yi-yrlsk-fnsl-vrlk-v1:series:TP_YIOSBAPIYDEG_S16:3b8cf586994a
title: Semantic proposal for TP.YIOSBAPIYDEG.S16
status: approved
target_type: series
target_id: evds:TP.YIOSBAPIYDEG.S16
...
confidence: 0.9
source: heuristic
evidence_fingerprint: 3b8cf586994a8c6b244ef895660cfbb7ff6165c5
catalog_record_id: catalog:evds2:TP.YIOSBAPIYDEG.S16
memory_rule_ids: []
evidence:
  ticker: TP.YIOSBAPIYDEG.S16
  notebook_slug: yi-yrlsk-fnsl-vrlk-v1
  ...
  - '#    df_mevduat[''TP_YIOSBAPIYDEG_S2''] + df_mevduat[''TP_YIOSBAPIYDEG_S15'']
    #+ df_mevduat[''TP_YIOSBAPIYDEG_S16'']'
  indicator_hints: []
  notes: ''
llm_provider: ''
llm_model: ''
promoted_record_id: evds:TP.YIOSBAPIYDEG.S16
promoted_memory_rule_id: memory:global-tp-yiosbapiydeg-s16
notes: 'Catalog source: catalog:evds2:TP.YIOSBAPIYDEG.S16'
body: "# Semantic proposal for TP.YIOSBAPIYDEG.S16\n\n## Target\nseries | evds:TP.YIOSBAPIYDEG.S16\n\
  ...
  \ catalog:evds2:TP.YIOSBAPIYDEG.S16\n\n## Evidence\n{\n  \"ticker\": \"TP.YIOSBAPIYDEG.S16\"\
  ...
  ,\n    \"source:yiyrlsk-mkk-fon-manual\",\n    \"source:yiyrlsk-vap-scrape-attempt\"\
  \n  ],\n  \"catalog_record\": {\n    \"id\": \"catalog:evds2:TP.YIOSBAPIYDEG.S16\"\
  ,\n    \"title\": \"1.A.1.5.Hanehalkına Hizmet Veren Kar Amacı Olmayan Kuruluşlar\
  \ (S.15) (Finansal Olmayan Kuruluş İhraçları)\",\n    \"frequency\": \"weekly\"\
  ,\n    \"unit\": \"milyon TL\",\n    \"data_group\": \"bie_yiosbapiydeg\",\n   \
  \ \"category\": \"GENEL YÖNETİM DIŞI SEKTÖRLERİN YURT İÇİ BORÇLANMA SENEDİ İHRAÇLARI\"\
  \n  },\n  \"memory_rules\": [],\n  \"source_snippets\": [\n    \"'TP.YIOSBAPIYDEG.S2',\
  ...
  \ Tahvil (Tüzel Kişi, 1)\\\"] = df_yi_yerlesik[\\\"TP_YIOSBAPIYDEG_S2\\\"] + (df_yi_yerlesik[\\\
  ...
  \ df_mevduat['TP_YIOSBAPIYDEG_S16']\"\n  ],\n  \"indicator_hints\": [],\n  \"notes\"\
  : \"\"\n}\n"
path: proposals\proposal%3Ayi-yrlsk-fnsl-vrlk-v1%3Aseries%3ATP_YIOSBAPIYDEG_S16%3A3b8cf586994a.md
approval_reason: LLM returned no concrete blocker after deterministic safety checks.
approval_mode: auto_llm
---
# Semantic proposal for TP.YIOSBAPIYDEG.S16
...
## Notes
Catalog source: catalog:evds2:TP.YIOSBAPIYDEG.S16
...
## Evidence
{
  ...
  "source_snippets": [
    ...
    "#    df_mevduat['TP_YIOSBAPIYDEG_S2'] + df_mevduat['TP_YIOSBAPIYDEG_S15'] #+ df_mevduat['TP_YIOSBAPIYDEG_S16']"
  ],
  "indicator_hints": [],
  "notes": ""
}
