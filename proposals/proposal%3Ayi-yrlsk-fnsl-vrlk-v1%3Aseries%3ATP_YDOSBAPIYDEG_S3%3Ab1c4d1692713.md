...
id: proposal:yi-yrlsk-fnsl-vrlk-v1:series:TP_YDOSBAPIYDEG_S3:b1c4d1692713
proposal_id: proposal:yi-yrlsk-fnsl-vrlk-v1:series:TP_YDOSBAPIYDEG_S3:b1c4d1692713
title: Semantic proposal for TP.YDOSBAPIYDEG.S3
status: approved
target_type: series
target_id: evds:TP.YDOSBAPIYDEG.S3
...
confidence: 0.9
source: heuristic
evidence_fingerprint: b1c4d169271316f999421671e556360b09757898
catalog_record_id: catalog:evds2:TP.YDOSBAPIYDEG.S3
memory_rule_ids: []
evidence:
  ticker: TP.YDOSBAPIYDEG.S3
  notebook_slug: yi-yrlsk-fnsl-vrlk-v1
...
llm_provider: ''
llm_model: ''
promoted_record_id: evds:TP.YDOSBAPIYDEG.S3
promoted_memory_rule_id: memory:global-tp-ydosbapiydeg-s3
notes: 'Catalog source: catalog:evds2:TP.YDOSBAPIYDEG.S3'
body: "# Semantic proposal for TP.YDOSBAPIYDEG.S3\n\n## Target\nseries | evds:TP.YDOSBAPIYDEG.S3\n\
  ...
  -\n\n## Source\nheuristic\n\n## Approval Mode\n-\n\n## Approval Reason\nLLM requested\
  \ manual review.\n\n## Notes\nCatalog source: catalog:evds2:TP.YDOSBAPIYDEG.S3\n\
  \n## Evidence\n{\n  \"ticker\": \"TP.YDOSBAPIYDEG.S3\",\n  \"notebook_slug\": \"\
  ...
  \ İhraçları)\",\n    \"frequency\": \"weekly\",\n    \"unit\": \"milyon ABD doları\"\
  ,\n    \"data_group\": \"bie_ydosbapiydeg\",\n    \"category\": \"GENEL YÖNETİM\
  \ DIŞI SEKTÖRLERİN YURT DIŞI BORÇLANMA SENEDİ İHRAÇLARI\"\n  },\n  \"memory_rules\"\
  : [],\n  \"source_snippets\": [\n    \"'TP.YDOSBAPIYDEG.S15', 'TP.YDOSBAPIYDEG.S34',\
  \ 'TP.YDOSBAPIYDEG.S53', 'TP.YDOSBAPIYDEG.S72', #özel sektör eurobond - gerçek kişiler\"\
  ,\n    \"'TP.YDOSBAPIYDEG.S2', 'TP.YDOSBAPIYDEG.S3', 'TP.YDOSBAPIYDEG.S5', 'TP.YDOSBAPIYDEG.S11',\
  \ 'TP.YDOSBAPIYDEG.S16', #özel sektör eurobond - tüzel kişiler\",\n    \"'TP.YDOSBAPIYDEG.S21',\
  ...
  \"] + df_yi_yerlesik[\\\"TP_YDOSBAPIYDEG_S16\\\"])\"\n  ],\n  \"indicator_hints\"\
  : [],\n  \"notes\": \"\"\n}\n"
path: proposals\proposal%3Ayi-yrlsk-fnsl-vrlk-v1%3Aseries%3ATP_YDOSBAPIYDEG_S3%3Ab1c4d1692713.md
approval_reason: LLM returned no concrete blocker after deterministic safety checks.
approval_mode: auto_llm
---
# Semantic proposal for TP.YDOSBAPIYDEG.S3
