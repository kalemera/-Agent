...
id: proposal:tbl-apko:series:TP_HPBITABLO4_7:4e5fa7a3b896
proposal_id: proposal:tbl-apko:series:TP_HPBITABLO4_7:4e5fa7a3b896
...
confidence: 0.9
source: heuristic
evidence_fingerprint: 4e5fa7a3b8968db2bcd4038b4384071d5c1cc4a2
catalog_record_id: catalog:evds2:TP.HPBITABLO4.7
memory_rule_ids: []
evidence:
  ticker: TP.HPBITABLO4.7
  notebook_slug: tbl-apko
  official_series_name: Bankalar YP Mevduat Stoku (Yurtiçi Yerleşikler, Gerçek Kişi,
    Kıymetli Maden)
  context_title: Bankalar YP Mevduat Stoku (Yurtiçi Yerleşikler, Gerçek Kişi, Kıymetli
    Maden)
  frequency: weekly
  ...
  memory_rules: []
  source_snippets:
  - '"TP.HPBITABLO4.7": "Bankalar YP Mevduat Stoku (Yurtiçi Yerleşikler, Gerçek Kişi,
    Kıymetli Maden)",'
  indicator_hints: []
  notes: ''
llm_provider: ''
...
body: "# Semantic proposal for TP.HPBITABLO4.7\n\n## Target\nseries | evds:TP.HPBITABLO4.7\n\
  ...
  : \"Bankalar YP Mevduat Stoku (Yurtiçi Yerleşikler, Gerçek Kişi, Kıymetli Maden)\"\
  ,\n  \"context_title\": \"Bankalar YP Mevduat Stoku (Yurtiçi Yerleşikler, Gerçek\
  \ Kişi, Kıymetli Maden)\",\n  \"frequency\": \"weekly\",\n  \"unit\": \"milyon ABD\
  \ doları\",\n  \"role\": \"balance_sheet_line\",\n  \"status\": \"derived_input\"\
  ,\n  \"theme_ids\": [\n    \"theme:apko-summary\",\n    \"theme:external-financing\"\
  ,\n    \"theme:banking-balance-sheet\",\n    \"theme:reserves-and-liquidity\"\n\
  ...
  \ (HAFTALIK) (TCMB)\"\n  },\n  \"memory_rules\": [],\n  \"source_snippets\": [\n\
  \    \"\\\"TP.HPBITABLO4.7\\\": \\\"Bankalar YP Mevduat Stoku (Yurtiçi Yerleşikler,\
  \ Gerçek Kişi, Kıymetli Maden)\\\",\"\n  ],\n  \"indicator_hints\": [],\n  \"notes\"\
  : \"\"\n}\n"
path: C:\Users\bthkr\OneDrive\Masaüstü\İş Kodlama\İş Agentı\proposals\proposal%3Atbl-apko%3Aseries%3ATP_HPBITABLO4_7%3A4e5fa7a3b896.md
...
## Evidence
{
  "ticker": "TP.HPBITABLO4.7",
  "notebook_slug": "tbl-apko",
  "official_series_name": "Bankalar YP Mevduat Stoku (Yurtiçi Yerleşikler, Gerçek Kişi, Kıymetli Maden)",
  "context_title": "Bankalar YP Mevduat Stoku (Yurtiçi Yerleşikler, Gerçek Kişi, Kıymetli Maden)",
  "frequency": "weekly",
  "unit": "milyon ABD doları",
  "role": "balance_sheet_line",
  "status": "derived_input",
  ...
  "memory_rules": [],
  "source_snippets": [
    "\"TP.HPBITABLO4.7\": \"Bankalar YP Mevduat Stoku (Yurtiçi Yerleşikler, Gerçek Kişi, Kıymetli Maden)\","
  ],
  "indicator_hints": [],
  "notes": ""
}
