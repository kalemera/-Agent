...
id: proposal:yi-yrlsk-fnsl-vrlk-v1:series:TP_YDOSBAPIYDEG_S24:36ad9891215e
proposal_id: proposal:yi-yrlsk-fnsl-vrlk-v1:series:TP_YDOSBAPIYDEG_S24:36ad9891215e
title: Semantic proposal for TP.YDOSBAPIYDEG.S24
status: approved
target_type: series
target_id: evds:TP.YDOSBAPIYDEG.S24
...
confidence: 0.9
source: heuristic
evidence_fingerprint: 36ad9891215e26416ecb1559e69b8144bd34fbb9
catalog_record_id: catalog:evds2:TP.YDOSBAPIYDEG.S24
memory_rule_ids: []
evidence:
  ticker: TP.YDOSBAPIYDEG.S24
  notebook_slug: yi-yrlsk-fnsl-vrlk-v1
...
llm_provider: ''
llm_model: ''
promoted_record_id: evds:TP.YDOSBAPIYDEG.S24
promoted_memory_rule_id: memory:global-tp-ydosbapiydeg-s24
notes: 'Catalog source: catalog:evds2:TP.YDOSBAPIYDEG.S24'
body: "# Semantic proposal for TP.YDOSBAPIYDEG.S24\n\n## Target\nseries | evds:TP.YDOSBAPIYDEG.S24\n\
  ...
  \ Notes\nCatalog source: catalog:evds2:TP.YDOSBAPIYDEG.S24\n\n## Evidence\n{\n \
  \ \"ticker\": \"TP.YDOSBAPIYDEG.S24\",\n  \"notebook_slug\": \"yi-yrlsk-fnsl-vrlk-v1\"\
  ,\n  \"official_series_name\": \"Bankalar (S.122) (Bankalar Tarafından İhraç Edilen)\"\
  ,\n  \"context_title\": \"Bankalar (S.122) (Bankalar Tarafından İhraç Edilen)\"\
  ,\n  \"frequency\": \"weekly\",\n  \"unit\": \"milyon ABD doları\",\n  \"role\"\
  ...
  : [\n    \"source:yiyrlsk-mkk-hisse-manual\",\n    \"source:yiyrlsk-mkk-fon-manual\"\
  ,\n    \"source:yiyrlsk-vap-scrape-attempt\"\n  ],\n  \"catalog_record\": {\n  \
  \  \"id\": \"catalog:evds2:TP.YDOSBAPIYDEG.S24\",\n    \"title\": \"1.B.1.2.2.Bankalar\
  \ (S.122) (Banka İhraçları)\",\n    \"frequency\": \"weekly\",\n    \"unit\": \"\
  milyon ABD doları\",\n    \"data_group\": \"bie_ydosbapiydeg\",\n    \"category\"\
  ...
  \"TP_YDOSBAPIYDEG_S34\\\"])\",\n    \"df_yi_yerlesik[\\\"Özel Sektör Eurobond (Bankalar)\\\
  \"] = df_yi_yerlesik['TP_DK_USD_A_YTL'] * (df_yi_yerlesik[\\\"TP_YDOSBAPIYDEG_S5\\\
  \"] + df_yi_yerlesik[\\\"TP_YDOSBAPIYDEG_S24\\\"] + df_yi_yerlesik[\\\"TP_YDOSBAPIYDEG_S43\\\
  \"] + df_yi_yerlesik[\\\"TP_YDOSBAPIYDEG_S62\\\"])\"\n  ],\n  \"indicator_hints\"\
  : [],\n  \"notes\": \"\"\n}\n"
path: proposals\proposal%3Ayi-yrlsk-fnsl-vrlk-v1%3Aseries%3ATP_YDOSBAPIYDEG_S24%3A36ad9891215e.md
approval_reason: LLM returned no concrete blocker after deterministic safety checks.
approval_mode: auto_llm
---
# Semantic proposal for TP.YDOSBAPIYDEG.S24
