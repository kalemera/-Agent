...
id: proposal:dth-blg-v7:series:TP_HPBITABLO4_20:8b4935cd7668
proposal_id: proposal:dth-blg-v7:series:TP_HPBITABLO4_20:8b4935cd7668
...
confidence: 0.9
source: heuristic
evidence_fingerprint: 8b4935cd7668d7c22241d889bb1668bc1a9f3ff4
...
evidence:
  ...
  official_series_name: d. Kıymetli Maden Depo Hesapları - ABD Doları Karşılığı (Milyon
    ABD Doları)
  context_title: C. Yurt Dışı Yerleşikler (Milyon ABD Doları) / d. Kıymetli Maden
    Depo Hesapları - ABD Doları Karşılığı (Milyon ABD Doları)
  frequency: weekly
...
body: "# Semantic proposal for TP.HPBITABLO4.20\n\n## Target\nseries | evds:TP.HPBITABLO4.20\n\
  ...
  \ (Milyon ABD Doları)\",\n  \"context_title\": \"C. Yurt Dışı Yerleşikler (Milyon\
  \ ABD Doları) / d. Kıymetli Maden Depo Hesapları - ABD Doları Karşılığı (Milyon\
  \ ABD Doları)\",\n  \"frequency\": \"weekly\",\n  \"unit\": \"Milyon ABD Doları\"\
  ,\n  \"role\": \"currency_split_line\",\n  \"status\": \"fetched_only\",\n  \"theme_ids\"\
  : [\n    \"theme:dth\"\n  ],\n  \"indicator_ids\": [],\n  \"source_dependency_ids\"\
  : [\n    \"source:dth-old-series-excel\"\n  ],\n  \"catalog_record\": {\n    \"\
  id\": \"catalog:evds2:TP.HPBITABLO4.20\",\n    \"title\": \"1.3.4.Kıymetli Maden\
  \ Depo Hesapları - ABD Doları Karşılığı\",\n    \"frequency\": \"weekly\",\n   \
  \ \"unit\": \"milyon ABD doları\",\n    \"data_group\": \"bie_hpbitablo4\",\n  \
  \  \"category\": \"PARA VE BANKA İSTATİSTİKLERİ (HAFTALIK) (TCMB)\"\n  },\n  \"\
  memory_rules\": [],\n  \"source_snippets\": [\n    \"'TP.HPBITABLO4.17', 'TP.HPBITABLO4.18',\
  \ 'TP.HPBITABLO4.19', 'TP.HPBITABLO4.20',\",\n    \"'TP_HPBITABLO4_20': 'C.d. Kıymetli\
  \ Maden',\"\n  ],\n  \"indicator_hints\": [],\n  \"notes\": \"\"\n}\n"
path: C:\Users\bthkr\OneDrive\Masaüstü\İş Kodlama\İş Agentı\proposals\proposal%3Adth-blg-v7%3Aseries%3ATP_HPBITABLO4_20%3A8b4935cd7668.md
...
## Evidence
{
  ...
  "context_title": "C. Yurt Dışı Yerleşikler (Milyon ABD Doları) / d. Kıymetli Maden Depo Hesapları - ABD Doları Karşılığı (Milyon ABD Doları)",
  "frequency": "weekly",
  "unit": "Milyon ABD Doları",
  "role": "currency_split_line",
  "status": "fetched_only",
