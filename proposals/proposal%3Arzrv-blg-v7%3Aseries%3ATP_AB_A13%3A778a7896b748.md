...
id: proposal:rzrv-blg-v7:series:TP_AB_A13:778a7896b748
proposal_id: proposal:rzrv-blg-v7:series:TP_AB_A13:778a7896b748
title: Semantic proposal for TP.AB.A13
status: approved
target_type: series
target_id: evds:TP.AB.A13
ticker: TP.AB.A13
notebook_slug: rzrv-blg-v7
notebook_path: C:\Users\bthkr\OneDrive\Masaüstü\İş Kodlama\Telegram Bot\notebooks\Rzrv_Blg_V7.ipynb
candidate_title: P.1ba Kamu ve Diğer Döviz Mevduatı
...
confidence: 0.85
source: hybrid
evidence_fingerprint: 778a7896b748a3a4adcc97b2f8217856b3f3a176
catalog_record_id: catalog:evds2:TP.AB.A13
memory_rule_ids: []
evidence:
  ticker: TP.AB.A13
  notebook_slug: rzrv-blg-v7
  official_series_name: P.1ba_Kamu ve Diğer Döviz Mevduatı(Bin TL)
  context_title: P.1ba_Kamu ve Diğer Döviz Mevduatı(Bin TL)
  frequency: daily
  unit: Bin TL
  ...
  - 'reserve_data_df["Kamu Mevduat"] = (reserve_data_df["TP_AB_A13"]/1000) / reserve_data_df["TP_DK_USD_A_YTL"]
...
promoted_record_id: evds:TP.AB.A13
promoted_memory_rule_id: memory:global-tp-ab-a13
notes: 'Catalog source: catalog:evds2:TP.AB.A13'
body: "# Semantic proposal for TP.AB.A13\n\n## Target\nseries | evds:TP.AB.A13\n\n\
  ## Notebook\nrzrv-blg-v7\n\n## Candidate Title\nP.1ba Kamu ve Diğer Döviz Mevduatı\n\
  \n## Candidate Unit\nBin TL\n\n## Candidate Frequency\ni̇ş günü\n\n## Candidate\
  \ Role\nbalance_sheet_line\n\n## Confidence\n0.85\n\n## Candidate Themes\n- theme:reserves\n\
  - theme:net-reserve-estimate\n\n## Candidate Indicator Inputs\n- derived:estimated-net-reserve\n\
  \n## Formula Hint\nderived:estimated-net-reserve: Dis varlik ve yukumluluk bloklarindan\
  \ tahmini net rezerv uretir.\n\n## Source\nhybrid\n\n## Notes\nCatalog source: catalog:evds2:TP.AB.A13\n\
  \n## Evidence\n{\n  \"ticker\": \"TP.AB.A13\",\n  \"notebook_slug\": \"rzrv-blg-v7\"\
  ,\n  \"official_series_name\": \"P.1ba_Kamu ve Diğer Döviz Mevduatı(Bin TL)\",\n\
  \  \"context_title\": \"P.1ba_Kamu ve Diğer Döviz Mevduatı(Bin TL)\",\n  \"frequency\"\
  : \"daily\",\n  \"unit\": \"Bin TL\",\n  \"role\": \"balance_sheet_line\",\n  \"\
  ...
  \   \"[\\\"TP.AB.A02\\\", 'TP.AB.A10', 'TP.AB.A11', 'TP.AB.A14', 'TP.AB.A13', 'TP.DK.USD.A.YTL'],\"\
  ,\n    \"reserve_data_df[\\\"Kamu Mevduat\\\"] = (reserve_data_df[\\\"TP_AB_A13\\\
  ...
  \"\n}\n"
path: C:\Users\bthkr\OneDrive\Masaüstü\İş Kodlama\İş Agentı\proposals\proposal%3Arzrv-blg-v7%3Aseries%3ATP_AB_A13%3A778a7896b748.md
---
# Semantic proposal for TP.AB.A13
...
## Evidence
{
  ...
  "source_snippets": [
    ...
    "[\"TP.AB.A02\", 'TP.AB.A10', 'TP.AB.A11', 'TP.AB.A14', 'TP.AB.A13', 'TP.DK.USD.A.YTL'],",
    "reserve_data_df[\"Kamu Mevduat\"] = (reserve_data_df[\"TP_AB_A13\"]/1000) / reserve_data_df[\"TP_DK_USD_A_YTL\"] # pdf verisi milyon dolar, evds verisi bin tl",
