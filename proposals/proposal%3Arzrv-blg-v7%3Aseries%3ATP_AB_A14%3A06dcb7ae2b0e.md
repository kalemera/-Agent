...
id: proposal:rzrv-blg-v7:series:TP_AB_A14:06dcb7ae2b0e
proposal_id: proposal:rzrv-blg-v7:series:TP_AB_A14:06dcb7ae2b0e
title: Semantic proposal for TP.AB.A14
status: approved
target_type: series
target_id: evds:TP.AB.A14
ticker: TP.AB.A14
notebook_slug: rzrv-blg-v7
notebook_path: C:\Users\bthkr\OneDrive\Masaüstü\İş Kodlama\Telegram Bot\notebooks\Rzrv_Blg_V7.ipynb
candidate_title: P.1bb Bankalar Döviz Mevduatı
...
confidence: 0.95
source: hybrid
evidence_fingerprint: 06dcb7ae2b0e9719e6c8e230d15628da183101a8
catalog_record_id: catalog:evds2:TP.AB.A14
memory_rule_ids: []
evidence:
  ticker: TP.AB.A14
  notebook_slug: rzrv-blg-v7
  official_series_name: P.1bb_Bankalar Döviz Mevduatı(Bin TL)
  context_title: P.1bb_Bankalar Döviz Mevduatı(Bin TL)
  frequency: daily
  unit: Bin TL
  ...
  - 'reserve_data_df["Bankalar Mevduat"] = (reserve_data_df["TP_AB_A14"]/1000) / reserve_data_df["TP_DK_USD_A_YTL"]
...
promoted_record_id: evds:TP.AB.A14
promoted_memory_rule_id: memory:global-tp-ab-a14
notes: 'Catalog source: catalog:evds2:TP.AB.A14'
body: "# Semantic proposal for TP.AB.A14\n\n## Target\nseries | evds:TP.AB.A14\n\n\
  ## Notebook\nrzrv-blg-v7\n\n## Candidate Title\nP.1bb Bankalar Döviz Mevduatı\n\n\
  ## Candidate Unit\nBin TL\n\n## Candidate Frequency\ni̇ş günü\n\n## Candidate Role\n\
  balance_sheet_line\n\n## Confidence\n0.95\n\n## Candidate Themes\n- theme:reserves\n\
  - theme:net-reserve-estimate\n\n## Candidate Indicator Inputs\n- derived:estimated-net-reserve\n\
  \n## Formula Hint\nderived:estimated-net-reserve: Dis varlik ve yukumluluk bloklarindan\
  \ tahmini net rezerv uretir.\n\n## Source\nhybrid\n\n## Notes\nCatalog source: catalog:evds2:TP.AB.A14\n\
  \n## Evidence\n{\n  \"ticker\": \"TP.AB.A14\",\n  \"notebook_slug\": \"rzrv-blg-v7\"\
  ,\n  \"official_series_name\": \"P.1bb_Bankalar Döviz Mevduatı(Bin TL)\",\n  \"\
  context_title\": \"P.1bb_Bankalar Döviz Mevduatı(Bin TL)\",\n  \"frequency\": \"\
  daily\",\n  \"unit\": \"Bin TL\",\n  \"role\": \"balance_sheet_line\",\n  \"status\"\
  ...
  \   \"[\\\"TP.AB.A02\\\", 'TP.AB.A10', 'TP.AB.A11', 'TP.AB.A14', 'TP.AB.A13', 'TP.DK.USD.A.YTL'],\"\
  ,\n    \"reserve_data_df[\\\"Bankalar Mevduat\\\"] = (reserve_data_df[\\\"TP_AB_A14\\\
  ...
  \"\n}\n"
path: C:\Users\bthkr\OneDrive\Masaüstü\İş Kodlama\İş Agentı\proposals\proposal%3Arzrv-blg-v7%3Aseries%3ATP_AB_A14%3A06dcb7ae2b0e.md
---
# Semantic proposal for TP.AB.A14
...
## Evidence
{
  ...
  "source_snippets": [
    ...
    "[\"TP.AB.A02\", 'TP.AB.A10', 'TP.AB.A11', 'TP.AB.A14', 'TP.AB.A13', 'TP.DK.USD.A.YTL'],",
    "reserve_data_df[\"Bankalar Mevduat\"] = (reserve_data_df[\"TP_AB_A14\"]/1000) / reserve_data_df[\"TP_DK_USD_A_YTL\"] # pdf verisi milyon dolar, evds verisi bin tl",
