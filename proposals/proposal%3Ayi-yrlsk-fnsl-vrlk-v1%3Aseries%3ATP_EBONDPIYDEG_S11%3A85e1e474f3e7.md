...
id: proposal:yi-yrlsk-fnsl-vrlk-v1:series:TP_EBONDPIYDEG_S11:85e1e474f3e7
proposal_id: proposal:yi-yrlsk-fnsl-vrlk-v1:series:TP_EBONDPIYDEG_S11:85e1e474f3e7
title: Semantic proposal for TP.EBONDPIYDEG.S11
status: approved
target_type: series
target_id: evds:TP.EBONDPIYDEG.S11
...
confidence: 0.9
source: heuristic
evidence_fingerprint: 85e1e474f3e709a46b3a7cf2ee76adf1056bf017
catalog_record_id: catalog:evds2:TP.EBONDPIYDEG.S11
memory_rule_ids: []
evidence:
  ticker: TP.EBONDPIYDEG.S11
  notebook_slug: yi-yrlsk-fnsl-vrlk-v1
...
llm_provider: ''
llm_model: ''
promoted_record_id: evds:TP.EBONDPIYDEG.S11
promoted_memory_rule_id: memory:global-tp-ebondpiydeg-s11
notes: 'Catalog source: catalog:evds2:TP.EBONDPIYDEG.S11'
body: "# Semantic proposal for TP.EBONDPIYDEG.S11\n\n## Target\nseries | evds:TP.EBONDPIYDEG.S11\n\
  ...
  \ Notes\nCatalog source: catalog:evds2:TP.EBONDPIYDEG.S11\n\n## Evidence\n{\n  \"\
  ticker\": \"TP.EBONDPIYDEG.S11\",\n  \"notebook_slug\": \"yi-yrlsk-fnsl-vrlk-v1\"\
  ,\n  \"official_series_name\": \"Finansal Olmayan Kuruluşlar (S.11)\",\n  \"context_title\"\
  ...
  : [],\n  \"source_snippets\": [\n    \"'TP.EBONDPIYDEG.S11', 'TP.EBONDPIYDEG.S12',\
  \ 'TP.EBONDPIYDEG.S122', #eurobond\",\n    \"df_yi_yerlesik['Eurobond (Tüzel Kişi)']\
  \ = df_yi_yerlesik['TP_DK_USD_A_YTL'] * (df_yi_yerlesik['TP_EBONDPIYDEG_S11'] +\
  ...
  \ + df_mevduat['TP_EBONDPIYDEG_S14'])#+ df_mevduat['TP_EBONDPIYDEG_S15'])\"\n  ],\n\
  \  \"indicator_hints\": [],\n  \"notes\": \"\"\n}\n"
path: proposals\proposal%3Ayi-yrlsk-fnsl-vrlk-v1%3Aseries%3ATP_EBONDPIYDEG_S11%3A85e1e474f3e7.md
approval_reason: LLM returned no concrete blocker after deterministic safety checks.
approval_mode: auto_llm
---
# Semantic proposal for TP.EBONDPIYDEG.S11
